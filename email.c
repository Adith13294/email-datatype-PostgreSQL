/* COMP9315 Project : Creating a new Datatype EmailAddr
   z5177910 : Adith Kumar Sukumar
   z5188837 : Philip Thomas Nedumpuram
...
// Checks if the length of the input string is atmost 256 
//as per RFC822 standard
...
//Logic for hash function as the first character decides into what bucket we store the function
// possible input in one of the 26 buckets
int hashFn(char *str) {
    return ((int) (*str));
}
...
//Checks if the email address is valid by subjecting it to various tests
//Comparision are made based on the ASCII character values
//Own implementation
...
//string comparision function for lexical comparision
...
//intermediate function used for string comparision
...
email_in(PG_FUNCTION_ARGS) {
    ...
    // Splits the email into local and domain parts and calls checkIfValidEmail to 
    //run tests
    ...
    //If all the tests are passed , then rebuild the string and prepare it for 
